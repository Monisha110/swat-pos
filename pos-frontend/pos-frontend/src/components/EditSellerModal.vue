<template>
  <div class="modal--bg">
    <div class="modal--content">
      ...
      >
        <div>
          <p class="modal--header--text">Update Seller details</p>
        </div>
        <div>
...
import { updateSellerData } from "../service/seller.service";
// import Vue from "vue";
export default {
 ...
 props: {
  ...
  watch: {
    ...
    mounted() {
    const propsProduct = this.sellerdata;
    console.log(this.sellerdata)
    
    console.log("inside if loop")
      this.seller.userId = propsProduct.userId;
      this.seller.userName = propsProduct.userName;
      this.seller.userEmail=propsProduct.userEmail;
      this.seller.userPassword=propsProduct.userPassword;
    this.seller.confirm_password=propsProduct.userPassword;
    this.seller.userPhoneNo=propsProduct.userPhoneNo;
